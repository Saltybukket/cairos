...
docs-check:
	...
	@if grep -R "pipx install cairos$$" -n --include="*.md" --exclude-dir=.git --exclude-dir=.venv --exclude-dir=reports cairos scripts .; then echo "Stale pipx package name found"; exit 1; fi
